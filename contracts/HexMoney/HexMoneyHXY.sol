...
contract HexMoneyHXY is ReentrancyGuard, HexMoneySettings {
    ...
    function exchangeHex(uint256 amount) public {
        require(
            IERC20(hexToken).transferFrom(_msgSender(), address(this), amount),
            "exchange amount greater than approved"
        );
